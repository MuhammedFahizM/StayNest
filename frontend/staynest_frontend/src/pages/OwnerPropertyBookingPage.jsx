...
export default function OwnerPropertyBookingPage() {
  ...
  const handleDeposit =
    async () => {
      ...
      try {
        await ownerMarkDepositReturned(
          id,
          depositAmount ||
            undefined
        );
                    ...
                    {[
                      ...
                      <button
                        ...
                        onClick={async () => {
                          try {
                            await api.get(
                              `/accounts/public/user/${b.user}/`
                            );

                            navigate(
                              `/owner/view-user/${b.user}`
                            );
                          } catch {
                            toast.error(
                              "Profile access not allowed"
                            );
                          }
                        }}
                      >
